...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SocialPageSettings'
        db.create_table('social_tags_socialpagesettings', (
        ...
        db.send_create_signal('social_tags', ['SocialPageSettings'])


    def backwards(self, orm):
        # Deleting model 'SocialPageSettings'
        db.delete_table('social_tags_socialpagesettings')
    ...
    models = {
        ...
        'social_tags.socialpagesettings': {
            'Meta': {'object_name': 'SocialPageSettings'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
